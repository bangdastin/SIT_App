      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
            ...
            <div>
              <label className="label">NIP / NRK <span className="text-rose-400 normal-case">*</span></label>
              <input className="input" value={form.nipnik} onChange={e => f('nipnik', e.target.value)} placeholder="Nomor Induk Pegawai / NRK" />
            </div>
            <div>
              <label className="label">Kategori Dokumen <span className="text-rose-400 normal-case">*</span></label>
