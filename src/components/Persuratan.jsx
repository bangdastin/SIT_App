      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
            <div>
              <label className="label">Kategori Surat <span className="text-rose-400 normal-case">*</span></label>
            ...
            <div>
              <label className="label">Upload File Surat (PDF) <span className="text-rose-400 normal-case">*</span></label>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl w-full max-w-2xl border border-slate-200 shadow-xl my-8">
            <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
              <h3 className="font-bold text-slate-800">Detail Surat</h3>
